<template>
  <q-layout view="lHh Lpr lFf">
    ...
    <q-drawer
      ...
      show-if-above
      :breakpoint="500"
      content-class="text-white bg-indigo-10"
    >
      ...
      <q-list>
        <q-item class="justify-center text-center q-mb-md q-mt-md">
          <div>
            ...
            <div class="text-weight-bold q-mt-md">devi anggraini</div>
        ...
        <q-item clickable active-class="active" :to="{ name: 'inputBarang' }" exact>
          <q-item-section avatar>
            <q-icon name="input"/>
          </q-item-section>
          <q-item-section>
